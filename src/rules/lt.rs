...
pub fn lt() -> Vec<Rewrite> {
    vec![
        ...
        //NON
        rw!("lt-non-1"     ; "( < ( min ?y ( / ( + ?x ?c2 ) ?c0 ) ) ( / ?x ?c0 ) )" => "1"  if crate::trs::compare_c0_c1("?c0", "?c2", "c2+c0<=0")),
        rw!("lt-non-2"     ; "( < ( min ?y ( / ( + ?x ?c2 ) ?c0 ) ) ( / ( + ?x ?c1 ) ?c0 ) )" => "1"  if crate::trs::compare_c0_c1_c2("?c0", "?c1", "?c2", "c2<=c1-c0")),
